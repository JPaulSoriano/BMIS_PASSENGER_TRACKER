...
class _MapState extends State<Map> {
  ...
  static const LatLng _center =
      const LatLng(16.050841249999998, 120.34084646235496);
  ...
  void initState() {
    super.initState();
    databaseReference.child('DriverID').once().then((DataSnapshot snapshot) {
    ...
    databaseReference.child('DriverID').onChildAdded.listen(_onEntryAdded);
    databaseReference.child('DriverID').onChildChanged.listen(_onEntryAdded);
  }
  ...
  _ChangePosi(position) async {
    ...
    CameraPosition _position1 =
        CameraPosition(bearing: 192.833, target: position, zoom: 15.0);
